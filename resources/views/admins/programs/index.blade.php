            ...
            <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    <td>{{ $data->id }}</td>
                    <td>
                        <a href="{{ route('inclusive.show',$data->id) }}">{{ $data->tour_name }}<inclusive.show/a>
                        </td>
                    ...
                    <td><a href="{{ route('editProgram',$data->id) }}"><i class="fa fa-edit"></i></a>
                      <a href="/destroyf/{{$data->id}} " onclick="return confirm('Are you sure? You want to delete {{ $data->tour_name}}','Inclusive')"><i class="fa fa-trash red"></i></a></td>
                  </tr>
                  @endforeach
