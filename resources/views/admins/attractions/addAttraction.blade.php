...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>New Attraction Page</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">New Attractions</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <input type="hidden" name="user_id" value="{{ Auth::id() }}">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                      <label for="inputEmail3" class="col-sm-4 col-md-4 col-form-label">Attraction Title</label>
                      <div class="col-sm-8 col-md-8">
                        <input type="text" class="form-control" name="attraction_title"  placeholder="Attraction Title">
                      </div>
                        </div>
                    </div>
                  ...
                  <div class="col-md-12 col-sm-6 col-xs-12">
                      <label class="control-label" for="attraction_description">Description
                       ...
                       <textarea name="attraction_description"   class="form-control"></textarea>
