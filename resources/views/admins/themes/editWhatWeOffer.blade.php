        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card card-outline card-info">
             ...
             <input type="hidden" name="id_unique" value="{{$messageBody->id_unique}}">
                <div class="card-body">
                ...
                <div class="row" id="title">          
                 <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="form-group">                      
                      <div class="col-sm-8 col-md-8"><label for="post_category" class="">Message title </label>
                        <input type="text" class="form-control" name="title"  value="{{$messageBody->title}}">
                      </div>
                        </div>
                    </div>
                </div>
                  ...
                  <div class="col-md-12 col-sm-6 col-xs-12">
                      <label class="control-label" for="post_body">Message Body/Description
                       ...
                       <textarea name="post_body" class="form-control">{{$messageBody->body}}</textarea>
